...
<body>
    ...
    <% while(result.next()) {%>
        ...
        <div>
            ...
            <div onmouseover="changeColorEvent(this, 'blue')"  onclick="showPostContentEvent(<%=result.getInt(post.postid)%>)">제목: <%=result.getString("post.title")%></div>
        </div>
    ...
    <script>
        ...
        function showPostContentEvent(idx){
            var postidValue = idx;
